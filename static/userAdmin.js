...
function init(){
    ...
    fetch('https://gagrica-rest.herokuapp.com/admin/users' ,{
        headers: {
    ...
    document.getElementById('submitBtn').addEventListener('click', e => {
        ...
        console.log(token)
        fetch('https://gagrica-rest.herokuapp.com/admin/users/'+selected, {
                    method: 'PUT',
    ...
    console.log(number)  
     ...
     const data = {
        id: number,
            ...
            let path = 'https://gagrica-rest.herokuapp.com/admin/users/' + number
        fetch(path, {
            method: 'DELETE',
...
function selectUsr(row){
    ...
    fetch('https://gagrica-rest.herokuapp.com/admin/users/'+number,{
        headers: {
        'Authorization': `Bearer ${token}`
       }
    })
