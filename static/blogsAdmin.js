...
function selectBlog(row){
    ...
    fetch('https://gagrica-rest.herokuapp.com/blogs/'+number, {
        headers: {
            'Authorization': `Bearer ${token}`
        }
    })
    ...
    fetch('https://gagrica-rest.herokuapp.com/admin/comments/'+number, {
        headers: {
            'Authorization': `Bearer ${token}`
        }
    })
    ...
    console.log(number)  
     ...
     const data = {
        id: number,
            ...
            let path = 'https://gagrica-rest.herokuapp.com/admin/comments/' + number
        fetch(path, {
            method: 'DELETE',
            headers: { 'Content-Type': 'application/json' ,
            'Authorization': `Bearer ${token}`},
